            ...
            {comments.length > 0 && (
                ...
                scrollbar-thumb-black scrollbar-thin">
                    {comments.map(comment =>(
                        <div key={comment.id} classnmae="flex items-center
                        space-x-2 mb-3">
                            <img 
                            ...
                            <span classNmae="font-bold">{comment.data().username}
                            </span>{""}
                            {comment.data().comment}
                            </p>
                            <p className="pr-5 text-xs">
                            {comment.data().timestamp 
                            ? formatDistanceToNow(comment.data().timestamp.toDate(), { addSuffix: true }) 
                            : "Some time ago"
                            }
                            </p>
                        </div>
